...
public class gmailLoginForNewUser implements IAutoConstants {
    ...
    public void loginAppWithNo() throws MalformedURLException, InterruptedException {
        ...
        driver.getKeyboard().sendKeys("ambikaambate96@gmail.com",Keys.ENTER);
        Thread.sleep(20000);
        driver.getKeyboard().sendKeys("ambikasaggam@96",Keys.ENTER);
        Thread.sleep(20000);
        driver.getKeyboard().sendKeys(Keys.ENTER);
        Thread.sleep(10000);
